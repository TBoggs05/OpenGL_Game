    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        glClear(GL_COLOR_BUFFER_BIT);
          ...
          // bind textures on corresponding texture units
           ...
           // glm::mat4 trans = glm::mat4(1.0f);
            //first input: matrix to rotate. Second input: axis about which to rotate
           // trans = glm::rotate(trans, glm::radians(90.0f), glm::vec3(0.0, 0.0, 1.0));
            //scale by 0.5 on each element.
           // trans = glm::scale(trans, glm::vec3(0.5, 0.5, 0.5));  
            ...
            trans2 = glm::scale(trans2, glm::vec3(glm::sin((float)glfwGetTime()), 1.0f, 1.0f));
            unsigned int transformLoc2 = glGetUniformLocation(triangleShader.ID, "transform");
